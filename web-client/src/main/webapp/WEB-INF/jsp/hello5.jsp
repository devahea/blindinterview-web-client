...
<!-- Mirrored from agileui.com/demo/monarch/demo/admin-angular/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Aug 2016 13:04:39 GMT -->
<head>
...
<link rel="shortcut icon" href="agileui/assets/images/icons/favicon.png">
    ...
    <link rel="stylesheet" type="text/css" href="agileui/assets-minified/admin-all-demo.css">
    ...
    <script src="agileui/assets/angular/angular.js"></script>
    <script src="agileui/assets/angular/angular-route.js"></script>
    <script src="agileui/assets/angular/angular-animate.js"></script>
    <script type="text/javascript" src="agileui/assets/angular/app.js"></script>

    <link rel="stylesheet" type="text/css" href="agileui/assets/angular/page-animations.css">
    ...
    <div id="header-nav-right">
        ...
        <a class="header-btn" id="logout-btn" href="http://agileui.com/" title="Lockscreen page example">
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li><a href="#labels-badges" title="Labels & Badges"><span>Labels &amp; Badges</span></a></li>
                ...
                <li><a href="#response-messages" title="Response messages"><span>Response messages</span></a></li>
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li><a href="#bs-carousel" title="Bootstrap Carousel"><span>Bootstrap carousel</span></a></li>
                ...
                <li><a href="#loading-feedback" title="Loading feedback"><span>Loading feedback</span></a></li>
                <li><a href="#popovers-tooltips" title="Popovers & Tooltips"><span>Popovers & Tooltips</span></a></li>
                <li><a href="#progress-bars" title="Progress bars"><span>Progress bars</span></a></li>
                <li><a href="#sortable-elements" title="Sortable elements"><span>Sortable elements</span></a></li>
            </ul>
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li><a href="#forms-validation" title="Form validation"><span>Form validation</span></a></li>
                ...
                <li><a href="#dropzone-uploader" title="Dropzone uploader"><span>Dropzone uploader</span></a></li>
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li><a href="#responsive-tables" title="Responsive tables"><span>Responsive tables</span></a></li>
                <li><a href="#data-tables" title="Data tables"><span>Data tables</span></a></li>
                <li><a href="#advanced-datatables" title="Advanced data tables"><span>Advanced data tables</span></a></li>
                <li><a href="#fixed-datatables" title="Fixed data tables"><span>Fixed data tables</span></a></li>
                <li><a href="#responsive-datatables" title="Responsive data tables"><span>Responsive data tables</span></a></li>
            </ul>
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                <li><a href="#index-alt" title="Alternate dashboard"><span>Alternate dashboard</span></a></li>
                ...
                <li><a href="#portfolio-gallery" title="Portfolio gallery"><span>Portfolio gallery</span></a></li>
                <li><a href="#portfolio-masonry" title="Portfolio masonry"><span>Portfolio masonry</span></a></li>
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                <li><a href="#login-1" target="_blank" title="Login page 1"><span>Login page 1</span></a></li>
                <li><a href="#login-2" target="_blank" title="Login page 2"><span>Login page 2</span></a></li>
                <li><a href="#login-3" target="_blank" title="Login page 3"><span>Login page 3</span></a></li>
                <li><a href="#login-4" target="_blank" title="Login page 4"><span>Login page 4</span></a></li>
                <li><a href="#login-5" target="_blank" title="Login page 5"><span>Login page 5</span></a></li>
                <li><a href="#lockscreen-1" target="_blank" title="Lockscreen page 1"><span>Lockscreen page 1</span></a></li>
                <li><a href="#lockscreen-2" target="_blank" title="Lockscreen page 2"><span>Lockscreen page 2</span></a></li>
                <li><a href="#lockscreen-3" target="_blank" title="Lockscreen page 3"><span>Lockscreen page 3</span></a></li>
                <li><a href="#server-1" target="_blank" title="Server page 1"><span>Error 404 page</span></a></li>
                <li><a href="#server-2" target="_blank" title="Server page 2"><span>Error 404 alternate</span></a></li>
                <li><a href="#server-3" target="_blank" title="Server page 3"><span>Server 500 error</span></a></li>
            </ul>
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                ...
                <li><a href="#page-transitions" title="Page transitions"><span>Page transitions</span></a></li>
    ...
    <!-- JS Demo -->
<script type="text/javascript" src="agileui/assets-minified/admin-all-demo.js"></script>


</div>
</body>

<!-- Mirrored from agileui.com/demo/monarch/demo/admin-angular/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Aug 2016 13:04:54 GMT -->
</html>